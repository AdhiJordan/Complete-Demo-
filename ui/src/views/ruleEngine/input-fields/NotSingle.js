...
import AttributeSingle from 'views/ruleEngine/AttributeSingle'
...
class NotSingle extends React.Component {
 ...
 this.addAttributeEdited = this. addAttributeEdited.bind(this);
 this.updateAttribute = this.updateAttribute.bind(this);
   ...
   updateAttribute(e) {
    ...
    addAttributeEdited(e, a) {
      e.preventDefault();
      alert("single first crete in single");
      this.setState({checked: !this.state.checked})
   
      console.log(this.props.rule.id);
      if(this.props.rule.id == undefined)
        
      console.log(this.state.singles);
      this.props.addToSingle(this.state.singles, a);   
    ...
    console.log(rule);
		...
		return (
			...
			<div>
              ...
              <Checkbox
               onCheck={this.addAttributeEdited}
