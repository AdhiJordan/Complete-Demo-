...
import 'app/css/rulescreen/css/ruleapp.css';
import 'app/css/rulescreen/css/wizard.css';
import 'app/css/rulescreen/css/app.css';
import classNames from 'classnames'
import {RadioButton, RadioButtonGroup} from 'material-ui'
import DisplayAttribute from 'views/ruleEngine/DisplayAttribute'
import _ from 'lodash'
import Ajv from 'ajv'
import entitySchema from 'schema/entity'
import TextInput from 'views/ruleEngine/input-fields/TextInput';
import SelectInput from 'views/ruleEngine/input-fields/SelectInput';
import NotSingle from 'views/ruleEngine/input-fields/NotSingle';
import ShowEditDetails from 'views/ruleEngine/input-fields/ShowEditDetails';
import NotOfNested from 'views/ruleEngine/input-fields/NotOfNested';
import NotCustomer from 'views/ruleEngine/input-fields/NotCustomer';
import CustomerSegment from 'views/ruleEngine/input-fields/CustomerSegment';
import NewCustomerSegment from 'views/ruleEngine/input-fields/NewCustomerSegment';
import OperandDrop from 'views/ruleEngine/dropdown/OperandDrop';
import {RaisedButton} from 'material-ui'
import 'app/css/rulescreen/css/fresh.css';
import DisplayRuleAttribute from 'views/ruleEngine/DisplayRuleAttribute';
import DisplaySingleAttribute from 'views/ruleEngine/DisplaySingleAttribute';
import NewRule from './NewRule';
import SearchTextbox from 'views/ruleEngine/TextBox/SearchTextbox';
...
class RulePage extends React.Component {
        ...
        addAttribute(e) {
            ...
            this.props.actions.createRule(ruletwo);
        ...
        render() {
              ...
              let {onClick, onChange, singles, nesteds, mains} = this.props;
...
{this.customerSegment()}
            ...
            {_(_.clone(mains.rules)).reverse().map((rule) => <ShowEditDetails
...
const selector = createSelector(
  state => state.ruleScreen.mains,
  state => state.ruleScreen.customer,
  (mains, customer) => ({ mains, customer })
)
