...
export function clearFieldsInEditComponent() {
	return { type: types.CLEAR_ENTITY_EDIT};
}
...
export default function reducer(state = initialState, action) {
  ...
  switch(type) {
    ...
    case types.CLEAR_ENTITY_EDIT:
      return update(state, { entityName: { $set: '' }, attributeName: { $set: '' }, attributeType: { $set: '' }, attributes: { $set: []} });
